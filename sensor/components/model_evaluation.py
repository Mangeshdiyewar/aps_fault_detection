...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            logging.info("Previous trained object of transformer, model and target encoder")
            ...
            print(f"Predictions using previous trained model :{target_encoder.inverse_transform(y_pred[:5])}")
            previous_model_score =f1_score(y_true=y_true, y_pred=y_pred)
            logging.info(f"Accuracy usiong previous trained model:{previous_model_score}")


            #accuracy using trained model
